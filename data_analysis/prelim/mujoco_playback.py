...
Run with mjpython (called automatically by data_analysis.py):
    mjpython data_analysis/prelim/mujoco_playback.py --file telemetry/Apr18_r90_1.csv
...
def main():
    ...
    # Resolve model path relative to repo root (data_analysis/prelim/ -> repo root)
