...
// Last time the sensor hub delivered SH2_GAME_ROTATION_VECTOR (not just "quat unchanged").
...
// BNO085 can stop producing reports (I2C / SH2 stall). Re-init without power-cycling the Teensy.
